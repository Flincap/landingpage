  ...
  const categories = [
    {
      ...
      description:
        "Entities that issue stablecoins pegged to various fiat currencies or assets.",
    },
    {
      icon: <Globe className="h-12 w-12" />,
      title: "Blockchain Platforms",
      description:
        "Companies providing the underlying technology for stablecoin transactions.",
    },
    {
      icon: <Building2 className="h-12 w-12" />,
      title: "Financial Institutions and Fintechs",
      description:
        "Banks, payment processors, and fintech firms utilizing stablecoins for transactions.",
    },
    {
      icon: <Users className="h-12 w-12" />,
      title: "Policy and Regulatory Stakeholders",
      description:
        "Government bodies and regulators shaping the legal framework for stablecoin use.",
    },
    {
      icon: <BookOpen className="h-12 w-12" />,
      title: "Academic and Research Partners",
      description:
        "Universities and think tanks researching the impact and potential of stablecoins.",
    },
    {
      icon: <Building className="h-12 w-12" />,
      title: "Enterprise and NGOs",
      description:
        "Organizations leveraging stablecoins for cross-border payments and financial inclusion projects.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <p className="text-blue-100 max-w-2xl mx-auto mb-8">
            Each member category plays a vital role in building a robust
            stablecoin ecosystem in Africa. Together, we can drive innovation,
            adoption, and positive change.
          </p>
          <a
