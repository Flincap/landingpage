...
const ConferenceSection = () => {
  ...
  return (
    <section id="conference" className="py-20 bg-neutral-50 relative overflow-hidden">
      {/* Background accents */}
      ...
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="md:flex">
            ...
            <div className="md:w-2/5 bg-blue-900 p-8 flex items-center justify-center">
              <div className="text-center">
                <h3 className="text-white text-3xl font-bold mb-4">November 7, 2025</h3>
                <p className="text-blue-100 text-xl mb-6">Four Points by Sheraton</p>
                <p className="text-blue-100 mb-8">Victoria Island, Lagos, Nigeria</p>
                <a
                  href="#join"
            ...
            <div className="md:w-3/5 p-8">
              <h3 className="text-2xl font-bold text-blue-900 mb-6">Conference Highlights</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-neutral-700">9:00 AM - 5:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-neutral-700">Industry leaders, regulators, innovators, and stakeholders from across Africa</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-neutral-700">Keynotes, panel discussions, workshops, and networking sessions</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                  {sessions.map((session, index) => (
                    <div key={index} className="flex items-center">
                      <span className="text-green-600 mr-2">•</span>
                      <span className="text-neutral-700 text-sm">{session}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-neutral-700 max-w-3xl mx-auto mb-8">
            The Africa Stablecoin Conference is the premier gathering for stablecoin enthusiasts, issuers, users, and regulators across the continent. Don't miss this opportunity to be part of shaping the future of digital finance in Africa.
          </p>
          <a
            href="#join"
